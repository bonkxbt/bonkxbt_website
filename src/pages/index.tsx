    ...
    <div className={clsx(
      ...
      <Layout>
        ...
        <Header style={{ display: 'flex', alignItems: 'center',justifyContent:"space-between", zIndex:"1",background:"#151517" }}>
          <a href="https://bonkxbt.mage.fun/" style={{marginRight:"24px"}}>
            <img className="bonkxbt-logo" src="/logo.png"/>
          </a>
          <Space style={{lineHeight: "normal"}} size="middle">
            <a href="https://github.com/mage-terminal/bonkxbt" target="_blank">
              <GithubOutlined style={{fontSize: '20px', color: '#f4f5f7'}}/>
            </a>
            <a href="https://x.com/bonkxbt_bot" target="_blank">
